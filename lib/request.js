...
var upstreamMethods = ['NOTIFY', 'PUT', 'REGISTER', 'DEREGISTER'];
...
exports.register = function(deviceid) {
  return new OrganiqRequest(deviceid, 'REGISTER');
};
exports.deregister = function(deviceid) {
  return new OrganiqRequest(deviceid, 'DEREGISTER');
};
